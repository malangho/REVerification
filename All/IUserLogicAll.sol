...
contract IUserLogicAll {
    ...
    function createUser(string calldata _firstname,
        string calldata _surname,
        string calldata _country,
        uint _refID,
        address _user,
        string calldata _organization) external;
    ...
    /// @param _user user
    /// @return returns user
    function getFullUser(address _user) public returns (string memory _firstname,
        string memory _surname,
        string memory _country,
        uint _refID,
        string memory _organization,
        uint _roles, bool _active);
    ...
    function updateUser(address _user, string calldata _firstname,
        string calldata _surname,
        string calldata _country, 
        uint _refID
        ) external;
