...
contract REVerificationPart is Initializable, RoleManagementPart{
    ...
    function initialize(address userlogic, address _certificateLogic) public initializer {
        RoleManagementPart.initialize(userlogic);
    ...
    function getAllFrameworkContracts() public view returns (Framework[] memory) {
        require(isRole(RoleManagementPart.Role.Issuer, msg.sender));
